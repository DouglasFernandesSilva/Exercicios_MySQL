...
insert into Historico(HMAT, HCOD_DISC, HCOD_TURMA, HCOD_PROF, HANO, frequência, nota) values
		('2015010101', 'BD', 1, '212131', 2015, 95, 9.5),
        ('2015010101', 'POO', 1, '192011', 2015, 90, 8),
        ('2015010101', 'WEB', 1, '192011', 2015, 97, 7.5),
		('2015010101', 'ENG', 1, '122135', 2015, 99, 8.5),
        
        ('2015010102', 'BD', 1, '212131', 2015, 98, 7.5),
        ('2015010102', 'POO', 1, '192011', 2015, 93, 6),
        ('2015010102', 'WEB', 1, '192011', 2015, 97, 8),
		('2015010102', 'ENG', 1, '122135', 2015, 95, 8.3),
        
        ('2015010103', 'BD', 1, '212131', 2015, 70, 2),
        ('2015010103', 'POO', 1, '192011', 2015, 93, 7.5),
        ('2015010103', 'WEB', 1, '192011', 2015, 84, 3.5),
		('2015010103', 'ENG', 1, '122135', 2015, 90, 6),
        
        ('2015010104', 'BD', 2, '212131', 2015, 98, 9.8),
        ('2015010104', 'POO', 1, '192011', 2015, 63, 1),
        ('2015010104', 'WEB', 1, '192011', 2015, 50, 0.5),
		('2015010104', 'ENG', 1, '122135', 2015, 96, 6),
        
        ('2015010105', 'BD', 2, '212131', 2015, 50, 0),
        ('2015010105', 'POO', 1, '192011', 2015, 60, 3),
        ('2015010105', 'WEB', 1, '192011', 2015, 79, 4.4),
		('2015010105', 'ENG', 1, '122135', 2015, 30, 2),
        
        ('2015010106', 'BD', 2, '212131', 2015, 100, 9.7),
        ('2015010106', 'POO', 1, '192011', 2015, 98, 8.3),
        ('2015010106', 'WEB', 1, '192011', 2015, 95, 9),
		('2015010106', 'ENG', 1, '122135', 2015, 99, 9.5);
        
select * from Historico;
        
select HMAT from Historico where HCOD_DISC = 'BD' and nota < 5;

select HMAT, avg(nota) as MEDIA from Historico where HCOD_DISC = 'POO' group by HMAT;

select HMAT, avg(nota) as MEDIA from Historico where HCOD_DISC = 'POO' group by HMAT having MEDIA > 6;
